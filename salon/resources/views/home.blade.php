        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading">
                        <h6>Our Services</h6>
                        <h2>Some of the most-used packages we bring.</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="owl-menu-item owl-carousel">
                    <div class="item">
                        <div class='card card1'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Hair-Color n' Care</h1>
                              <p class='description'>Have Hair-color, Hair-smoothening, Hair-cut, Hair-wash, Straightning & Styling.</p>
                    ...
                    <div class="item">
                        <div class='card card2'>
                            <div class="price"><h6>₹650</h6></div>
                            <div class='info'>
                              <h1 class='title'>Nail Care</h1>
                              <p class='description'>We bring to you best medicure and pedicures and satisfactory nail art designs.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                            </div>
                    ...
                    <div class="item">
                        <div class='card card3'>
                            <div class="price"><h6>₹2500</h6></div>
                            <div class='info'>
                              <h1 class='title'>Bridal Set</h1>
                              <p class='description'>On point styling with makeup and accessories for engagement, wedding & parties.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                            </div>
                    ...
                    <div class="item">
                        <div class='card card4'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Makeup Kit</h1>
                              <p class='description'>Makeup for any occasion with hair styling, booking can be done for groups.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                            </div>
                    ...
                    <div class="item">
                        <div class='card card5'>
                            <div class="price"><h6>₹500</h6></div>
                            <div class='info'>
                              <h1 class='title'>Mehndi</h1>
                              <p class='description'>Decorate your festive season with mehndi or henna.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>Our Stylists</h6>
                        <h2>We have to best staff for you.</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/staff-01.jpg" alt="Chef #1">
                        </div>
                        <div class="down-content">
                            <h4>Niharika Pandey</h4>
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/staff-02.jpg" alt="Chef #2">
                        </div>
                        <div class="down-content">
                            <h4>Rashmi Mishra</h4>
                            <span>Makeup and Accessories Artist 👒</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="assets/images/staff-03.jpg" alt="Chef #3">
                        </div>
                        <div class="down-content">
                            <h4>Pratineedhi Devi</h4>
                            <span>Facial and Skin Care 😷</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>Contact Us</h6>
                            <h2>Book an appointment with us Or contact us for queries. Or Just walkin to our salon</h2>
                        </div>
                        <p>We value your call. Our staff is all time avaialable so checkin as you like. The work timings are 11 AM to 8 PM. For Thrusday the timings are 3 PM to 8 PM.</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    <i class="fa fa-phone"></i>
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">910-090-0990</a><br><a href="#">910-091-0991</a></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">query@thequeen.com</a><br><a href="#">info@thequeen.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
